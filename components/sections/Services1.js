                    ...
                    <div className="row">
                        <div className="col-xl-6 col-md-12">
                            <div className="services__main">
                                <div className="services-box">
                                    ...
                                    <Link href="#" className="h6 title">Portfolio Manager</Link>
                                    <p>
                                ...
                                <div className="services-box">
                                    <div className="icon">
                                        <svg width={31} height={36} viewBox="0 0 31 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M23.6095 13.3208V9.3846C23.6095 4.77743 19.8732 1.0411 15.266 1.0411C10.6589 1.02093 6.90786 4.73893 6.8877 9.34793V9.3846V13.3208" stroke="#58BD7D" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                            <path fillRule="evenodd" clipRule="evenodd" d="M22.2525 34.9576H8.24399C4.40499 34.9576 1.29199 31.8464 1.29199 28.0056V20.1424C1.29199 16.3016 4.40499 13.1904 8.24399 13.1904H22.2525C26.0915 13.1904 29.2045 16.3016 29.2045 20.1424V28.0056C29.2045 31.8464 26.0915 34.9576 22.2525 34.9576Z" stroke="#58BD7D" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M15.2486 22.0381V26.1099" stroke="#58BD7D" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                    <Link href="#" className="h6 title">Vault protection</Link>
                                    <p>
                                ...
                                <div className="services-box">
                                    ...
                                    <Link href="#" className="h6 title">Mobile Apps</Link>
                                    <p>
                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="block-text" data-aos="fade-up" data-aos-duration={1000}>
                                ...
                                <Link href="#" className="btn-action">Let’s Trade Now</Link>
                            </div>
                        </div>
                    </div>
                </div>
