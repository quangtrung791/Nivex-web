                            ...
                            <div className="work__main">
                                <div className="work-box" style={{'background': '#3f3f3f54'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <p className="text fs-14" style={{'padding': '15px 40px 25px 40px'}}>
                                ...
                                <div className="work-box" style={{'background': '#3f3f3f54'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <Link href="#" className="title" style={{'fontSize' : '28px', 'fontWeight': '500', 'marginBottom': '5px', 'padding' : '0 15px'}}>GIAO DỊCH HỢP ĐỒNG</Link>
                                        <p className="text fs-14" style={{'padding': '15px 40px 25px 40px'}}>
                                ...
                                <div className="work-box" style={{'background': '#3f3f3f54'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <Link href="#" className="title" style={{'fontSize' : '28px', 'fontWeight': '500', 'marginBottom': '5px', 'padding' : '0 15px'}}>CHIẾN LƯỢC LỢI NHUẬN DO AI DẪN DẮT</Link>
                                        <p className="text fs-14" style={{'padding': '15px 40px 25px 40px'}}>
