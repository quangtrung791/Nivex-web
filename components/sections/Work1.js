                            ...
                            <div className="work__main">
                                <div className="work-box box-hanh-trinh-1-container" style={{'background': '#3f3f3f54', 'minHeight' : '276px', 'margin-right': '20px'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <h3 className="title fs-28 gradient-text" style={{'fontSize' : '28px', 'fontWeight': '700', 'marginBottom': '5px', 'padding' : '0 15px'}}>Kiến Thức <br></br>Là Nền Tảng</h3>
                                ...
                                <div className="work-box box-hanh-trinh-1-container" style={{'background': '#3f3f3f54', 'minHeight' : '276px', 'margin-right': '20px'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <h3 className="title gradient-text" style={{'fontSize' : '28px', 'fontWeight': '700', 'marginBottom': '5px', 'padding' : '0 15px'}}>Công Cụ Là<br></br> Phòng Thí Nghiệm</h3>
                                ...
                                <div className="work-box box-hanh-trinh-1-container last-el-wb" style={{'background': '#3f3f3f54',  'minHeight' : '276px'}}>
                                    ...
                                    <div className="content">
                                        ...
                                        <h3 className="title gradient-text" style={{'fontSize' : '28px', 'fontWeight': '700', 'marginBottom': '5px', 'padding' : '0 15px'}}>Phát Triển <br></br>Cùng Cộng Đồng</h3>
                                        <p className="text fs-14" style={{'padding': '5px 33px 25px 33px'}}>
