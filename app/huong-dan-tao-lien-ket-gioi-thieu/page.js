...
import HDLienKetGioiThieuComponent from './HuongDanTaoLienKetGioiThieuComponent'
...
export const metadata = {
  ...
  robots: {
    ...
    openGraph: {
        title: "Hướng dẫn tạo liên kết giới thiệu | Nivex Hub",
        description: "Chuyên trang hướng dẫn tạo liên kết giới thiệu, mời bạn bè, hoa hồng và nhiều thứ khác.",
        url: "https://nivex.info/huong-dan-tao-lien-ket-gioi-thieu",
        siteName: "Nivex",
        images: [
            {
...
export default function HuongDanTaoLienKetGioiThieuLayout() {
  return (
    <Layout headerStyle={1} footerStyle={2}>
      <HDLienKetGioiThieuComponent />
    </Layout>
  )
}