...
export default function AboutNivexContent() {
  useEffect(() => {
              ...
              <div className={styles.heroContent}>
                <div className={styles.heroDescription}>
                  ...
                  <p className={`${styles.description} ${styles.descriptionCustomedd}`}>
                    Nivex xây dựng một nền tảng giao dịch tập trung vào bảo mật, minh bạch phí và trải nghiệm mượt mà, với bộ công cụ AI cùng
                    với các tín hiệu quỹ tổ chức hàng đầu
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className={styles.visionCard}>
                ...
                <p className={styles.cardDescription}>
                  Trở thành nền tảng giao dịch đáng tin cậy cho cộng đồng, nơi công nghệ AI sẽ giúp mọi người tiếp cận thị trường một cách an
                  toàn và tăng trưởng bền vững
                </p>
              </div>
            </div>
            <div className="col-lg-6">
              <div className={styles.missionCard}>
                ...
                <p className={styles.cardDescription}>
                  Trao cho người dùng các công cụ giao dịch dễ dùng; áp dụng AI để hỗ trợ phân tích và quản trị rủi ro, từ đó nâng cao trải
                  nghiệm và hiệu quả ra quyết định.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={styles.productSection}>
        <div className="container">
          ...
          <div className={styles.aiStrategySection}>
            <div className={styles.displayFlexHeroContent}>
              <div className="col-lg-6">
                <div className={styles.productIcons}></div>
              </div>
              <div className={`col-lg-6 ${styles.displayFlexPropductStats}`}>
                ...
                <div className={styles.ctaButton}>
                  <a href="/ai-copy-trade" className={`btn-cta-simple ${styles.learnMoreBtn} ${styles.timHieuThemBtn}`}>
                    Tìm hiểu thêm
                  </a>
                </div>
              </div>
      ...
      <section className={styles.COFounderSectionContainer}>
        <div className="container">
          ...
          <div className={styles.aiStrategySection}>
            <div className={styles.displayFlexHeroContent}>
              <div className="col-lg-6">
                <div className={styles.COFounderImage}></div>
              </div>
              <div className={`col-lg-6 ${styles.displayFlexPropductStats}`}>
                <div className={styles.firstFounderStats}>
                  <div className={styles.statItem}>
                    ...
                    <div className={`${styles.statLabel} ${styles.COFounderDescription}`}>
                      Ông tập trung vào việc xây dựng một sàn giao dịch tiền mã hóa thế hệ mới dựa trên trí tuệ nhân tạo (AI), nhằm mang lại cho người dùng toàn
                      cầu trải nghiệm giao dịch thông minh và hiệu quả hơn. Ông không chỉ là người xây dựng trong lĩnh vực Web3, mà còn là nguồn động lực thúc
                      đẩy sự đổi mới cho toàn ngành.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={`${styles.aiStrategySection} ${styles.secondFounderSection}`}>
            <div className={styles.displayFlexHeroContent}>
              <div className="col-lg-6">
                <div className={styles.secondFounderImage}></div>
              </div>
              <div className={`col-lg-6 ${styles.displayFlexPropductStats}`}>
                <div className={styles.secondFounderStats}>
                  <div className={styles.statItem}>
                    ...
                    <div className={`${styles.statLabel} ${styles.COFounderDescription}`}>
                      Becky tập trung vào việc nghiên cứu, phát triển và quảng bá các chiến lược giao dịch bằng AI. Bà cam kết tạo ra trải nghiệm giao dịch tài
                      sản kỹ thuật số thông minh hơn, hiệu quả hơn và tự động hơn, thúc đẩy ứng dụng thực tiễn của công nghệ AI trong các kịch bản giao dịch,
                      mang đến cho người dùng các giải pháp giao dịch mang tính tiên phong và bền vững hơn.
                    </div>
                  </div>
                </div>
              </div>
